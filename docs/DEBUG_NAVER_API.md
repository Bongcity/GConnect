...
🔍 Testing endpoint: https://api.commerce.naver.com/external/v1/products?page=1&size=1
   ℹ️ Status: 404 Not Found
   ❌ Response: {"code":"GW.NOT_FOUND","message":"요청하신 리소스를 찾을 수 없습니다."...
🔍 Testing endpoint: https://api.commerce.naver.com/external/v2/products?page=1&size=1
   ℹ️ Status: 404 Not Found
   ❌ Response: {"code":"GW.NOT_FOUND"...
❌ 모든 엔드포인트 테스트 실패
```
...
1. https://commerce.naver.com/commerce-apis 접속
2. 확인 사항:
   - [ ] 애플리케이션 상태가 **"승인됨"**
   - [ ] **"상품" API가 선택**되어 있음
